fn main() {
    ...
    if std::env::var("CARGO_CFG_TARGET_OS").as_deref() == Ok("windows") {
        ...
        res.set("ProductVersion", "0.99.1.0");
        res.set("FileVersion", "0.99.1.0");
        res.set_version_info(
            winresource::VersionInfo::PRODUCTVERSION,
            0x0000_0063_0001_0000,
        );
        res.set_version_info(winresource::VersionInfo::FILEVERSION, 0x0000_0063_0001_0000);

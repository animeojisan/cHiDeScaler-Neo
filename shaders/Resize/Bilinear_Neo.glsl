/*
    Bilinear Resize Adjustable for cHiDeScaler-Neo v1.0
    --------------------------
...
//!HEIGHT HOOKED.h
//!DESC Bilinear Resize Adjustable Horizontal v1.0
vec4 hook()
{
...
//!DESC Bilinear Resize Adjustable Vertical v1.0
vec4 hook()
{

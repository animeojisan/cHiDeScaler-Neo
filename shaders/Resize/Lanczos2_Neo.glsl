/*
    Lanczos2 Resize Adjustable for cHiDeScaler-Neo v1.0
    --------------------------
...
//!HEIGHT HOOKED.h
//!DESC Lanczos2 Resize Adjustable Horizontal v1.0
vec4 hook()
{
    ...
    for (int tap = 0; tap < 64; ++tap)
    {
        ...
        else if (x < 2.0)
        {
            ...
            float pix = PI * x;
            weight = (sin(pix) / pix) * (sin(0.5 * pix) / (0.5 * pix));
        }
...
//!DESC Lanczos2 Resize Adjustable Vertical v1.0
vec4 hook()
{
